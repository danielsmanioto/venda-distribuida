...
Documentação consolidada do projeto (exceto os `README.md`, que permanecem em seus módulos).

## Estrutura

- [APIs](apis/API-EXAMPLES.md)
  - [Exemplos API Produtos](apis/PRODUTOS-CURL.md)
  - [Exemplos API Vendas](apis/VENDAS-CURL.md)
- [CI/CD Pipeline](cicd/CI-CD-PIPELINE.md)
  - [Quick Start CI/CD](cicd/CI-CD-QUICKSTART.md)
